...
-- 2
ALTER TYPE public.account_type OWNER TO cse340zh_3;
...
-- 6 Table structure for table 'account'
...
CREATE TABLE IF NOT EXISTS public.favorite (
	...
	account_id INT REFERENCES public.account NOT NULL,
	inv_id INT REFERENCES public.inventory NOT NULL,
	
	CONSTRAINT inv_fk FOREIGN KEY (inv_id) 
...
-- 7 Data for table 'classification'
